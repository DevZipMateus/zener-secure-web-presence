...
const ServicesSection = () => {
  const services = [
    ...
    {
      icon: <Camera className="w-6 h-6 sm:w-8 sm:h-8 text-primary" />,
    ...
    {
      icon: <DoorClosed className="w-6 h-6 sm:w-8 sm:h-8 text-primary" />,
    ...
    {
      icon: <Lock className="w-6 h-6 sm:w-8 sm:h-8 text-primary" />,
    ...
    {
      icon: <Radio className="w-6 h-6 sm:w-8 sm:h-8 text-primary" />,
      title: "Interfone",
            ...
            {services.map((service, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105">
                ...
                <CardContent className="pt-0">
                  <p className="text-sm sm:text-base text-zener-gray leading-relaxed">
                    {service.description}
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <div className="bg-primary p-6 sm:p-8 rounded-lg text-white">
              ...
              <button
                ...
                className="bg-white text-primary hover:bg-gray-100 font-semibold px-6 sm:px-8 py-3 rounded-lg transition-colors"
              >
                Solicitar Orçamento
              </button>
            </div>
